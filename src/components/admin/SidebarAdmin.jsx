...
const SidebarAdmin = ({ profile, loading }) => {
  ...
  const activeNavLinkClass =
    "bg-gradient-to-r from-blue-50 to-blue-100 text-blue-700 shadow-md scale-[1.01] ring-1 ring-blue-200 border border-blue-300";
  ...
  const menuItems = [
    {
      to: "/admin",
      icon: (
        <LayoutGrid className="w-6 h-6 group-hover:text-blue-500 transition" />
      ),
      label: "แดชบอร์ด",
    },
    {
      to: "manage",
      icon: <Users2 className="w-6 h-6 group-hover:text-blue-500 transition" />,
      label: "จัดการผู้ใช้",
    },
    {
      to: "reviews",
    ...
    },
    {
      to: "return-requests",
      icon: (
        <PackagePlus className="w-6 h-6 group-hover:text-blue-500 transition" />
      ),
  ...
  return (
    <>
      ...
      <button
        className="fixed top-4 left-4 z-40 p-2 rounded-lg bg-blue-600 text-white shadow-lg md:hidden border border-blue-700 active:scale-95 transition-transform"
      ...
      >
        ...
        <div className="h-24 bg-gradient-to-r from-blue-700 to-blue-900 flex items-center justify-between px-4 shadow-lg select-text cursor-default border-b border-blue-950">
          <div className="flex items-center gap-3">
        ...
        >
          <div className="flex flex-col items-center gap-4 w-full">
            ...
            <label className="px-4 py-2 bg-blue-600 text-white rounded-lg cursor-pointer hover:bg-blue-700 transition inline-flex items-center gap-2 font-medium shadow-md">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-5 h-5"
                viewBox="0 0 24 24"
        ...
        <nav className="flex-1 px-4 py-6 space-y-3 overflow-y-auto custom-scrollbar">
          ...
          <div className="mb-4">
            ...
            <div className="relative select-none mt-2">
              ...
              >
                <span className="flex items-center gap-3">
                  <Layers3 className="w-6 h-6 group-hover:text-blue-500 transition" />
            ...
            >
              <ReceiptText className="w-6 h-6 group-hover:text-blue-500 transition" />
